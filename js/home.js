...
window.addEventListener("load", function () {
    ...
    // Global BGM: start playing once after first user interaction
    let bgm_started = false;
    function start_bgm_once() {
    ...
    // Attach one-time listeners to start BGM after user interaction
    window.addEventListener("click", start_bgm_once, { once: true });
    window.addEventListener("wheel", start_bgm_once, { once: true });
    window.addEventListener("keydown", start_bgm_once, { once: true });
});
